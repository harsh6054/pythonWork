...
class RMS:
    def __init__(self, root):
        ...
        #.....Title
        title = Label(self.root, text="Student Result Managment System", padx=15, compound=LEFT,image=self.logo_dash, font=("goudy old style", 20, "bold"),bg="#033054", fg="white").place(x=0, y=0, relwidth=1, height=50)
        ...
        btn_view = Button(M_Frame, text="View", font=("goudy old style", 15, "bold"),bg="#0b5377", fg="white", cursor="hand2").place(x=680, y=5, width=200, height=40)
        ...
        self.lbl_student=Label(self.root,text="Total Student\n[ 0 ]",font=("goudy old style",20),bd=10,relief=RIDGE,bg="#0676ad",fg="white").place(x=710,y=530,width=300,height=100)
        
        self.lbl_result=Label(self.root,text="Total Result\n[ 0 ]",font=("goudy old style",20),bd=10,relief=RIDGE,bg="#038074",fg="white").place(x=1020,y=530,width=300,height=100)

        #.....Footer
        footer = Label(self.root,text="SRMS-Student Result Managment System\nContact Us for any Technical Issue: +9193xxxx54",padx=15, compound=LEFT, image=self.logo_dash,font=("goudy old style", 20), bg="#262626", fg="white")
